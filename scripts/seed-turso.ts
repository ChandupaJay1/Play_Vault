...
const games = [
  {
    title: "Crimson Fury",
    slug: "crimson-fury",
    description: "A fast-paced hack-and-slash action game set in a war-torn fantasy kingdom. Wield elemental weapons and unleash devastating combos against fearsome bosses.",
    price: 5990,
    originalPrice: 6990,
  ...
  },
  {
    ...
    description: "An open-world RPG set in a dark fantasy universe. Create your character, explore vast dungeons, and uncover ancient secrets.",
    price: 4990,
    originalPrice: 5990,
  ...
  },
  {
    title: "Neon Drift",
    slug: "neon-drift",
    description: "A high-octane racing game set in a cyberpunk city. Customize your vehicle, race through neon-lit streets, and dominate the underground racing scene.",
    price: 3990,
    originalPrice: null,
  ...
  },
  {
    ...
    description: "Build your empire, train armies, and conquer rival kingdoms in this grand strategy game. Lead your civilization from medieval village to global superpower.",
    price: 4490,
    originalPrice: 5490,
  ...
  },
  {
    ...
    slug: "space-frontier",
    description: "Explore the cosmos, build space stations, and establish colonies on distant planets. A comprehensive space simulation experience.",
    price: 3490,
    originalPrice: 4490,
  ...
  },
  {
    title: "Desert Storm",
    slug: "desert-storm",
    description: "An intense tactical FPS set in modern conflict zones. Lead your squad through challenging missions with realistic weapon mechanics.",
    price: 4990,
    originalPrice: 5990,
  ...
  },
  {
    title: "Mystic Quest",
    slug: "mystic-quest",
    description: "A charming adventure RPG with classic turn-based combat. Journey through magical lands, befriend quirky characters, and save the world from darkness.",
    price: 2990,
    originalPrice: 3990,
  ...
  },
  {
    ...
    description: "The most realistic football simulation with licensed teams and players. Experience match day like never before.",
    price: 5990,
    originalPrice: 6990,
...
async function main() {
  ...
  for (const g of games) {
    ...
    if (existing.rows.length === 0) {
      ...
      console.log(`Game "${g.title}" already exists, skipping`);
    }
