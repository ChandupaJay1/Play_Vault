...
export default function CheckoutPage() {
  ...
  const bankDetails = {
    bank: "Example Bank",
    accountName: "PlayVault Gaming LLC",
    accountNumber: "1234567890",
    routingNumber: "021000021",
    reference: `PV-${Date.now().toString(36).toUpperCase()}`,
  };
          ...
          <div className="bg-[#111127] border border-[#2a2a4a] rounded-2xl p-8 text-center">
            ...
            <div className="bg-[#0a0a1a] border border-[#2a2a4a] rounded-xl p-6 mb-6 text-left">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#f1f5f9]">{bankDetails.bank}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#64748b]">Account Name:</span>
                  <span className="text-[#f1f5f9]">{bankDetails.accountName}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#64748b]">Account Number:</span>
                  <div className="flex items-center gap-2">
                    <span className="text-[#f1f5f9]">{bankDetails.accountNumber}</span>
                    <button onClick={() => copyToClipboard(bankDetails.accountNumber)} className="text-[#f97316] hover:text-[#fb923c]">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[#eab308] font-mono">{bankDetails.reference}</span>
                    <button onClick={() => copyToClipboard(bankDetails.reference)} className="text-[#f97316] hover:text-[#fb923c]">
                      <Copy className="w-4 h-4" />
                    </button>
                  </div>
                </div>
            ...
            <div className="bg-[#0a0a1a] border border-[#2a2a4a] rounded-xl p-4 mb-6 text-left">
              <p className="text-[#94a3b8] text-sm">
                <span className="text-[#f59e0b] font-medium">Note:</span> After transferring, upload your payment proof in your dashboard. Your keys will be delivered after verification.
              </p>
            </div>
